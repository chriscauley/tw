DG.Generator = class Generator extends uR.RandomMixin(DG.Piece) {
    ...
    join_exits(piece1, piece1_exit, piece2, piece2_exit) {
        ...
        */
        ...
        if (ic) {
            piece1.remove_perimeter(new DG.Rectangle(piece1.local_pos([ic[0], ic[1]], [ic.width, ic.height])));
            piece2.remove_perimeter(new DG.Rectangle(piece2.local_pos([ic[0], ic[1]], [ic.width, ic.height])));
        }
    }
